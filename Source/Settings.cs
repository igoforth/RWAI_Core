...
namespace AICore
{
    public partial class AICoreSettings : ModSettings
    {
        ...
        public override void ExposeData()
        {
            ...
            Scribe_Values.Look(
                ref reportEnergyFrequency,
                "reportEnergyFrequency",
                defaultValue: 8000
            );
            Scribe_Values.Look(
                ref reportEnergyImmediate,
                "reportEnergyImmediate",
                defaultValue: false
            );

            // Research Insight settings
            Scribe_Values.Look(
                ref reportResearchStatus,
                "reportResearchStatus",
                defaultValue: false
            );
            Scribe_Values.Look(
            ...
            // Detailed Colonist Insight settings
            Scribe_Values.Look(
                ref reportColonistRoster,
                "reportColonistRoster",
                defaultValue: false
            );
            Scribe_Values.Look(
        ...
        public bool IsConfigured =>
            userApiConfigs.Any(a => a.Active)
            && ((azureSpeechKey?.Length > 0 && azureSpeechRegion?.Length > 0) || showAsText);
        ...
        public static readonly Color highlightedBackground =
            new(74 / 255f, 74 / 255f, 74 / 255f, 0.5f);
        ...
        public void DoWindowContents(Rect inRect)
        {
            ...
            var activeSecondaryId =
                (activeConfig?.SecondaryModelId.Length ?? 0) == 0
                    ? "None"
                    : activeConfig.SecondaryModelId.Split('/').Last()
                        ?? activeConfig.SecondaryModelId;
            ...
            if (selected != null)
            {
                ...
                selected.phraseBatchSize = Mathf.Min(
                    selected.phraseBatchSize,
